      ...
      <div class="col">
        <nav class="mb-4">
          <div class="nav nav-tabs" id="compiler-output-tabs" role="tablist">
            ...
            >
              Compiler Messages
              <span class="badge badge-primary">{{ compilerMessages.length }}</span>
            </a>
            <a
        ...
        <div class="tab-content" id="compiler-output-panels">
          ...
          >
            <div class="row">
              <div class="col">
                <pagination-nav
                  aria-label="Compilation Errors Navigator"
            ...
            <div class="row">
              <div class="col">
                <pre class="terminal-output" v-html="currentErrorMessage"></pre>
              </div>
            </div>
          </div>
        </div>
